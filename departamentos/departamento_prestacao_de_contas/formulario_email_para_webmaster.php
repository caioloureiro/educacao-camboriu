...
mail("prestacaodecontas.educacao@cidadedecamboriu.sc.gov.br", "Portal da Educacao",$msg,"From: $REMOTE_ADDR");
echo "Seu e-mail foi enviado com sucesso. Obrigado! Pressione BACKSPACE ( <-- ) para voltar ao Portal";
